...
class PluginTests(unittest.TestCase):
    def test_plugin_metadata_and_inheritance(self) -> None:
        ...
        self.assertEqual(plugin_class.VERSION, "0.6.0")
    ...
    def test_reporting_shortcuts_use_plugin_served_script(self) -> None:
        ...
        self.assertEqual(
            action["source"],
            "/plugin/inventory-manager/reporting.js:openReporting?v=0.6.0",
        )
        ...
        self.assertEqual(
            dashboard["source"],
            "/plugin/inventory-manager/reporting.js:renderReportingShortcut?v=0.6.0",
        )
